...
class StudentListViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = "Guess the age"
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "loadStudentView" {
            if let detailViewController = segue.destinationViewController as? StudentViewController,
                let selectedIndex = self.tableView.indexPathForSelectedRow?.row {
                
                let student = StudentController.students[selectedIndex]
